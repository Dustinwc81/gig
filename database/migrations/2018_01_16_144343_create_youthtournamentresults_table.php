...
class CreateYouthtournamentresultsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('youthtournamentresults', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('youthtournamentresults');
    }
}
